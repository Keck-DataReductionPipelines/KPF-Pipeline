"""
    ...
    Usage:
        ...
        where `raw_file_name` is the string to a L0 raw data file, `raw_file` is the raw FITS data, and `raw_min_bias` is what is now bias-subtracted raw data.
...
class BiasSubtraction(KPF0_Primitive):
    ...
    def _perform(self) -> None:
        """Primitive action - 
        perform bias subtraction by calling method 'bias_subtraction' from BiasSubtraction

        Returns:
            Level 0, bias-corrected, raw observation data
        """
