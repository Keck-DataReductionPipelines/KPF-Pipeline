...
data_type = 'KPF'
wls1_file = os.getenv('KPFPIPE_TEST_DATA') + '/masters/20240101/kpf_20240101_master_WLS_autocal-lfc-all-eve_L1.fits'
wls2_file = os.getenv('KPFPIPE_TEST_DATA') + '/masters/20240101/kpf_20240101_master_WLS_autocal-lfc-all-morn_L1.fits'
...
l1_file = os.getenv('KPFPIPE_TEST_DATA') + '/L1/' + datecode_l1 + '/' + obsid_l1 + '_L1.fits'
