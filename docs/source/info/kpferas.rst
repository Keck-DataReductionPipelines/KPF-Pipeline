...
The table below displays the contents of the file `static/kpfera_definitions.csv`, which defins the time period of KPF eras and has notes about the instrument changes betweent them.
