# -*- coding: utf-8 -*-
#
# KPFPipeline documentation build configuration file, created by
...
copyright = u'2020-2026, BJ Fulton, Andrew Howard, Sam Halverson, Aprita Roy, Cindy Wang, Russ Laher, Gerg Gilbert, and others on the KPF Team'
...
version = '.'.join(kpfpipe.__version__.split('.')[:-1])
...
htmlhelp_basename = 'KPFPipelinedoc'
...
man_pages = [
    (master_doc, 'kpfpipeline', u'KPFPipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KPFPipeline', u'KPFPipeline Documentation',
     author, 'KPFPipeline', 'One line description of project.',
     'Miscellaneous'),
]
