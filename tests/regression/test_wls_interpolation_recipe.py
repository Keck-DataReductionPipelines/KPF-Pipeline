...
recipe = open('tests/recipes/test_wls_interpolation.recipe', 'r').read()
config = 'tests/configs/test_wls_interpolation.cfg'

def test_wls_interpolation_recipe():
    recipe_test(recipe, config, date_dir='20240228')
