...
#. Develop the code to determine if a KPF file passes or fails a QC metric.  See `this Jupyter notebook <QC Example - Developing a QC method.ipynb>`_ for an example.  
...
#. Check that your QC works as expected.  See `this Jupyter notebook <QC Example - L0 Data Products Check.ipynb>`_ for an example.  
