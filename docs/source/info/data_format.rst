...
FINTRG9F  1.00                                        Flux inside 2D padded order trace regions (Green, 99.5th %ile, e-)
FOUTRG9F  1.00                                        Flux outside 2D padded order trace regions (Green, 99.5th %ile, e-)
FRATRG9F  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 99.5th %ile)
FINTRG99  1.00                                        Flux inside 2D padded order trace regions (Green, 99th %ile, e-)
FOUTRG99  1.00                                        Flux outside 2D padded order trace regions (Green, 99th %ile, e-)
FRATRG99  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 99th %ile)
FINTRG98  1.00                                        Flux inside 2D padded order trace regions (Green, 98th %ile, e-)
FOUTRG98  1.00                                        Flux outside 2D padded order trace regions (Green, 98th %ile, e-)
FRATRG98  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 98th %ile)
FINTRG95  1.00                                        Flux inside 2D padded order trace regions (Green, 95th %ile, e-)
FOUTRG95  1.00                                        Flux outside 2D padded order trace regions (Green, 95th %ile, e-)
FRATRG95  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 95th %ile)
FINTRG90  1.00                                        Flux inside 2D padded order trace regions (Green, 90th %ile, e-)
FOUTRG90  1.00                                        Flux outside 2D padded order trace regions (Green, 90th %ile, e-)
FRATRG90  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 90th %ile)
FINTRG50  1.00                                        Flux inside 2D padded order trace regions (Green, median, e-)
FOUTRG50  1.00                                        Flux outside 2D padded order trace regions (Green, median, e-)
FRATRG50  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, median)
FINTRG10  1.00                                        Flux inside 2D padded order trace regions (Green, 10th %ile, e-)
FOUTRG10  1.00                                        Flux outside 2D padded order trace regions (Green, 10th %ile, e-)
FRATRG10  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Green, 10th %ile)
FINTRR9F  1.00                                        Flux inside 2D padded order trace regions (Red, 99.5th %ile, e-)
FOUTRR9F  1.00                                        Flux outside 2D padded order trace regions (Red, 99.5th %ile, e-)
FRATRR9F  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 99.5th %ile)
FINTRR99  1.00                                        Flux inside 2D padded order trace regions (Red, 99th %ile, e-)
FOUTRR99  1.00                                        Flux outside 2D padded order trace regions (Red, 99th %ile, e-)
FRATRR99  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 99th %ile)
FINTRR98  1.00                                        Flux inside 2D padded order trace regions (Red, 98th %ile, e-)
FOUTRR98  1.00                                        Flux outside 2D padded order trace regions (Red, 98th %ile, e-)
FRATRR98  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 98th %ile)
FINTRR95  1.00                                        Flux inside 2D padded order trace regions (Red, 95th %ile, e-)
FOUTRR95  1.00                                        Flux outside 2D padded order trace regions (Red, 95th %ile, e-)
FRATRR95  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 95th %ile)
FINTRR90  1.00                                        Flux inside 2D padded order trace regions (Red, 90th %ile, e-)
FOUTRR90  1.00                                        Flux outside 2D padded order trace regions (Red, 90th %ile, e-)
FRATRR90  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 90th %ile)
FINTRR50  1.00                                        Flux inside 2D padded order trace regions (Red, median, e-)
FOUTRR50  1.00                                        Flux outside 2D padded order trace regions (Red, median, e-()
FRATRR50  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, median)
FINTRR10  1.00                                        Flux inside 2D padded order trace regions (Red, 10th %ile, e-)
FOUTRR10  1.00                                        Flux outside 2D padded order trace regions (Red, 10th %ile, e-)
FRATRR10  1.00                                        Flux ratio (in/out) in 2D padded order trace regions (Red, 10th %ile)
